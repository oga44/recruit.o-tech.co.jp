						...
						<div class="p-guideline__block">
							...
							<div class="grid grid-cols-1 p-guideline__gap--lg">
								<div class="grid grid-cols-1 p-guideline__gap">
									...
									<?php get_template_part(TYPO, null, [
										"text" => "大学卒　　250,528円（地域手当・住宅手当含む）<br>大学院了　256,888円（地域手当・住宅手当含む）",
									]); ?>
								</div>
								<?php /*
								<div class="grid grid-cols-1 p-guideline__gap">
								...
								<?php
									$flow = [
										...
										[
											"index" => "02",
											"hd" => "会社説明会",
											"desc" => "事業内容や会社の基本情報をご紹介します。日程等はマイナビまたはリクナビよりご確認ください。",
										],
										[
											"index" => "03",
											"hd" => "一次面接（WEB）",
										...
										[
											"index" => "04",
											"hd" => "適性検査（WEB）",
											"desc" => "適正試験（適性検査）を実施いたします。※専門知識は不要です。",
										],
										[
											"index" => "05",
											"hd" => "最終面接（対面）",
